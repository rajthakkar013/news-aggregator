...
Route::post('/news/fetch',        [NewsFetchController::class, 'fetchAll']);
Route::post('/news/fetch/{slug}', [NewsFetchController::class, 'fetchOne']);

Route::get('/news/preview/newsapi',  [NewsPreviewController::class, 'newsapi']);
Route::get('/news/preview/newsdata', [NewsPreviewController::class, 'newsdata']);
